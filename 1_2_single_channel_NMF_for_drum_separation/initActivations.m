...
%
% References:
% [1] Jonathan Driedger, Harald Grohganz, Thomas Pr채tzlich, Sebastian Ewert
% and Meinard M체ller "Score-informed audio decomposition and applications"
% In Proceedings of the ACM International Conference on Multimedia (ACM-MM)
% Barcelona, Spain, 2013.
%
% [2] Christian Dittmar and Meinard M체ller "Reverse Engineering the Amen
...
% [3]  Patricio L처pez-Serrano, Christian Dittmar, Yi?웙tcan ?뻵er, and Meinard
%     M체ller
