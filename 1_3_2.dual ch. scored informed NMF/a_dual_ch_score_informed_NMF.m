%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Name: dual channel score informed NMF
% Date: April 2021
%
% Description :
...
for i = 1:2:length(filename)
    ...
    paramActivations.onsets = importdata('d3_087_phrase_shuffle-blues_simple_fast_sticks_onsets.txt');
    paramActivations.drums = importdata('d3_087_phrase_shuffle-blues_simple_fast_sticks_drums.txt');
