...
%           Hthreshold     a judgment value making H matrix sparse.
%
...
% [3]  Patricio LÃ³pez-Serrano, Christian Dittmar, YiÄŸitcan Ã–zer, and Meinard
%     MÃ¼ller
...
if ~isfield(parameter, 'Hthreshold')
...
for iter = 1:L
  ...
  % delete H matrix value under threshold
  if isempty(parameter.Hthreshold) ~=1
      H(H<parameter.Hthreshold) = 0;
  end
